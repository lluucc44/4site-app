...
def calcular_mercado_potencial(datos_inegi, tipo_negocio_key, num_competidores, competidores=None):
    """
    Calcula el tamaño de mercado potencial en el área de 500m.
    Metodología: población × ingreso × % gasto × factor de captura,
    ajustado por la calidad de la competencia existente (rating).
    """
    ...
    calidad_penalty = 1.0 - (pct_excelente * 0.5) - max(0.0, rating_promedio - 4.0) * 0.15
    calidad_penalty = max(0.3, min(1.0, calidad_penalty))
