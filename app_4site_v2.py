    ...
    try:
        ...
        for p in places:
            ...
            if tipo_key == "medicina_estetica":
                ...
                if _tiene_kw_cafe or _es_tipo_cafe:
                    filtered.append(p)
...
if "resultados" in st.session_state:
    ...
    if tier_info["muestra_score_desglose"] and desglose:
        ...
        st.markdown(f"""
<div style='background:#0F1E33; border:1px solid #24405F; border-radius:12px;
     padding:18px 20px; margin:10px 0;'>
    <div style='display:flex; align-items:baseline; gap:10px; margin-bottom:10px;'>
        <span style='font-size:34px; font-weight:800; color:{_sat_col}; line-height:1;'>{_n_comp}</span>
        <span style='font-size:14px; color:#C9D6E5;'>competidores directos de tu giro en 500m</span>
    </div>
    <div style='display:flex; gap:20px; flex-wrap:wrap; font-size:13px; color:#9FB2C8;'>
        <span>Saturación aparente: <b style='color:{_sat_col};'>{_sat_txt}</b></span>
        <span>Calidad de la competencia: <b style='color:#C9D6E5;'>{_rating_txt}</b></span>
    </div>
    <div style='font-size:12px; color:#6E829B; margin-top:10px;'>
...
<div style='background:#F0F6FF; border-left:4px solid #2A6FDB;
    ...
    <div style='position:relative; border-radius:10px; overflow:hidden; margin-top:6px;'>
        <div style='padding:14px 16px; background:#122135;'>
            <div style='font-size:12px; color:#C9D6E5; margin-bottom:10px;'>
                <b>Desglose del score:</b>
            ...
            <div style='position:relative; border-radius:8px; overflow:hidden;'>
                <div style='filter:blur(5px); pointer-events:none; user-select:none;'>
                    <div style='font-size:12px; color:#C9D6E5; margin-bottom:8px;'>
                        <b>NSE de la zona:</b> ▓/C+ · Ingreso promedio: $▓▓,▓▓▓ mensual
                    </div>
                    <div style='font-size:12px; color:#C9D6E5;'>
                        <b>Top 5 para esta esquina:</b> 1.▓▓▓▓▓ 2.▓▓▓▓ 3.▓▓▓▓▓▓ 4.▓▓▓ 5.▓▓▓▓
                    </div>
                </div>
