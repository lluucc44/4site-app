...
/* Botón secundario — gris claro tipo tarjeta.
   Colores fijos + color-scheme light para que se vea igual en cualquier
...
/* Botones PRIMARIOS (fondo azul) -> texto blanco.
   Los secundarios ya llevan texto navy definido arriba. */
