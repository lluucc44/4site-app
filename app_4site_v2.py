        ...
        with st.spinner(f"Analizando zona de {radio_km:.0f} km a la redonda..."):
            try:
                ...
                <div style='display:grid; grid-template-columns:1fr 1fr 1fr; gap:12px; margin-top:8px;'>
                    <div style='background:#20364F; border-radius:8px; padding:12px;'>
...
if tier_key in ["pro", "premium", "premium2"]:
    ...
    if _tipo_plaza_detectado in ["mall", "strip_center", "plaza_ambigua"]:
        ...
        st.markdown(f"""<div style='background:#20364F; border-left:4px solid #D98A1F;
    ...
    with _col_pz2:
        if tipo_plaza == "mall":
            st.markdown("""<div style='background:#20364F; border-left:3px solid #2A6FDB;
            ...
            st.markdown("""<div style='background:#20364F; border-left:3px solid #555;
                border-radius:6px; padding:8px 12px; font-size:11px; color:#AAAAAA;'>
    ...
    if _tipo_plaza_detectado == "mall":
        tipo_plaza = "mall"
        st.markdown("""<div style='background:#20364F; border-left:4px solid #2A6FDB;
        ...
        st.markdown("""<div style='background:#20364F; border-left:4px solid #D98A1F;
            border-radius:6px; padding:10px 14px; margin:4px 0 8px;'>
...
if tipo_plaza == "mall":
    ...
    with _col_sc2:
        ...
        if ancla_strip in _tips_ancla:
            st.markdown(f"""<div style='background:#20364F; border-left:3px solid #2A6FDB;
...
with _col_flujo2:
    ...
    st.markdown(f"""<div style='background:#20364F; border-left:3px solid #555;
        border-radius:6px; padding:8px 12px; font-size:11px; color:#AAAAAA; margin-top:22px;'>
...
if modo == "zona_potencial":
    ...
    st.markdown("---")
    st.markdown("""
    <div style='background:#20364F; border:2px solid #2A6FDB; border-radius:12px;
...
if "resultados" in st.session_state:
    ...
    if tier_info["muestra_score_desglose"] and desglose:
        ...
        if _ip and _ip.get("tipo_plaza"):
            ...
            _pl_roi   = _ip.get("ajuste_roi_pct", 0)
            st.markdown(f"""
            <div style='background:#20364F; border-left:4px solid {_pl_color};
...
<div style='background:#F0F6FF; border-left:4px solid #2A6FDB;
    ...
    if tier_key != "free":
        ...
        <div style='display:flex; gap:12px; flex-wrap:wrap;'>
            <div style='flex:1; min-width:160px; background:#20364F; border-radius:8px; padding:10px 12px;'>
