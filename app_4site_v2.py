...
st.markdown(f"""
<div style='position:relative; border-radius:16px; overflow:hidden; margin-bottom:16px; min-height:260px;'>
    ...
    <div style='position:relative; z-index:2; text-align:center; padding:56px 20px 48px;'>
        <p style='color:#1F5FC2; font-size:16px; margin:0 0 10px; font-style:italic;
             text-shadow:0 1px 6px rgba(0,0,0,0.9);'>Don't guess. Foresee.</p>
        <p style='color:#FFFFFF; font-size:15px; margin:0 auto; max-width:460px; line-height:1.7;
