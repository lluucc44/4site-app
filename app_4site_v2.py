...
/* ── Barras-acordeon claras (lista de negocios recomendados) ──
   Colores fijos + color-scheme light para que se vean igual en cualquier
   telefono, tenga o no modo oscuro activado. */
.barra-clara div.stButton > button:not([kind="primary"]) {
...
.barra-clara div.stButton > button:not([kind="primary"]):hover {
    background: #E7EDF4 !important;
    background-color: #E7EDF4 !important;
    border-color: #CBD5E1 !important;
}
.barra-clara div.stButton > button:not([kind="primary"]):active,
.barra-clara div.stButton > button:not([kind="primary"]):focus {
    background-color: #E7EDF4 !important;
    color: #13243B !important;
    -webkit-text-fill-color: #13243B !important;
}
...
<div style='background:#0F1E33 !important; border:1px solid #24405F; border-radius:12px;
    ...
    if modo == "validar" and tier_key != "free":
        ...
        for i, rec in enumerate(recomendaciones[:top_n]):
            ...
            st.markdown('<div class="barra-clara">', unsafe_allow_html=True)
