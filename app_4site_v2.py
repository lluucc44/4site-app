...
/* Cajas custom con fondo OSCURO -> texto claro.
   El selector cubre el div mismo Y sus hijos (el texto suele ir
   directo en el div con el background inline).
   Cubre todos los fondos oscuros usados en la app. */
div[style*="#34537F"], div[style*="#34537F"] *,
div[style*="#34537f"], div[style*="#34537f"] *,
div[style*="#20364F"], div[style*="#20364F"] *,
div[style*="#20364f"], div[style*="#20364f"] *,
div[style*="#13243B"], div[style*="#13243B"] *,
div[style*="#13243b"], div[style*="#13243b"] *,
div[style*="#2A6FDB"], div[style*="#2A6FDB"] *,
div[style*="#2a6fdb"], div[style*="#2a6fdb"] *,
div[style*="#1F5FC2"], div[style*="#1F5FC2"] *,
div[style*="#1f5fc2"], div[style*="#1f5fc2"] *,
div[style*="#1F9D57"], div[style*="#1F9D57"] *,
div[style*="#1f9d57"], div[style*="#1f9d57"] *,
div[style*="#3A3A3A"], div[style*="#3A3A3A"] *,
div[style*="#3a3a3a"], div[style*="#3a3a3a"] *,
div[style*="#2A2A2A"], div[style*="#2A2A2A"] *,
div[style*="#2a2a2a"], div[style*="#2a2a2a"] * {
    color: #FFFFFF !important;
}
    ...
    if st.button("🗺️ Buscar mejores zonas", type="primary", use_container_width=True):
        ...
        with st.spinner(f"Analizando zona de {radio_km:.0f} km a la redonda..."):
            try:
                ...
                st.markdown("---")
                st.markdown("""
                <div style='background:#13243B; border-radius:12px; padding:20px 24px; color:white;'>
                ...
                <div style='display:grid; grid-template-columns:1fr 1fr 1fr; gap:12px; margin-top:8px;'>
                    <div style='background:#34537F; border-radius:8px; padding:12px;'>
...
if tier_key in ["pro", "premium", "premium2"]:
    ...
    if _tipo_plaza_detectado in ["mall", "strip_center", "plaza_ambigua"]:
        ...
        st.markdown(f"""<div style='background:#34537F; border-left:4px solid #D98A1F;
    ...
    with _col_pz2:
        if tipo_plaza == "mall":
            st.markdown("""<div style='background:#34537F; border-left:3px solid #2A6FDB;
                border-radius:6px; padding:8px 12px; font-size:11px; color:#6B7683;'>
            ...
            st.markdown("""<div style='background:#34537F; border-left:3px solid #555;
                border-radius:6px; padding:8px 12px; font-size:11px; color:#6B7683;'>
    ...
    if _tipo_plaza_detectado == "mall":
        tipo_plaza = "mall"
        st.markdown("""<div style='background:#34537F; border-left:4px solid #2A6FDB;
            ...
            <span style='color:#6B7683; font-size:12px;'>
        ...
        st.markdown("""<div style='background:#34537F; border-left:4px solid #D98A1F;
            border-radius:6px; padding:10px 14px; margin:4px 0 8px;'>
...
if tipo_plaza == "mall":
    ...
    with _col_sc2:
        ...
        if ancla_strip in _tips_ancla:
            st.markdown(f"""<div style='background:#34537F; border-left:3px solid #2A6FDB;
                border-radius:6px; padding:8px 12px; font-size:11px; color:#6B7683; margin-top:22px;'>
...
with _col_flujo2:
    ...
    st.markdown(f"""<div style='background:#34537F; border-left:3px solid #555;
        border-radius:6px; padding:8px 12px; font-size:11px; color:#6B7683; margin-top:22px;'>
...
if tier_key == "free":
    ...
    if tier_key == "premium2":
        ...
        if modo == "zona_potencial":
            ...
            st.markdown("""<div style='background:#13243B; border-radius:10px;
...
if modo == "zona_potencial":
    ...
    st.markdown("---")
    st.markdown("""
    <div style='background:#34537F; border:2px solid #2A6FDB; border-radius:12px;
...
if "resultados" in st.session_state:
    ...
    if tier_info["muestra_score_desglose"] and desglose:
        ...
        if _ip and _ip.get("tipo_plaza"):
            ...
            _pl_roi   = _ip.get("ajuste_roi_pct", 0)
            st.markdown(f"""
            <div style='background:#34537F; border-left:4px solid {_pl_color};
...
<div style='background:#0F1E33 !important; border:1px solid #24405F; border-radius:12px;
    ...
    if tier_key != "free":
        ...
        st.markdown("""
        <div style='background:#13243B; border-radius:12px; padding:18px 22px;
             color:white; margin-top:12px;'>
        <p style='font-size:12px; font-weight:700; color:#2A6FDB; margin:0 0 10px;'>
            💡 La ubicación es el punto de partida — el éxito depende también de:</p>
        <div style='display:flex; gap:12px; flex-wrap:wrap;'>
            <div style='flex:1; min-width:160px; background:#34537F; border-radius:8px; padding:10px 12px;'>
                <div style='color:#2A6FDB; font-weight:700; font-size:11px;'>🎫 Ticket promedio</div>
                <div style='color:#6B7683; font-size:10px; margin-top:4px;'>Calibra tu precio al NSE y competencia de la zona.</div>
            </div>
            <div style='flex:1; min-width:160px; background:#34537F; border-radius:8px; padding:10px 12px;'>
                <div style='color:#2A6FDB; font-weight:700; font-size:11px;'>🤝 Atención al cliente</div>
                <div style='color:#6B7683; font-size:10px; margin-top:4px;'>Tu rating en Google es tu segundo score de viabilidad.</div>
            </div>
            <div style='flex:1; min-width:160px; background:#34537F; border-radius:8px; padding:10px 12px;'>
                <div style='color:#2A6FDB; font-weight:700; font-size:11px;'>📱 Presencia en redes</div>
                <div style='color:#6B7683; font-size:10px; margin-top:4px;'>Google Maps, Instagram y WhatsApp Business son esenciales para convertir tráfico en clientes.</div>
            </div>
        </div>
        </div>""", unsafe_allow_html=True)
...
<div style='background:#F0F6FF; border-left:4px solid #2A6FDB;
    ...
    if tier_key == "free":
        st.markdown(f"""
<div style='background:#13243B; border-radius:12px; padding:20px 24px; margin:10px 0;'>
    <div style='color:#5B9BF5 !important; font-weight:700; font-size:15px; margin-bottom:8px;'>
        🔒 El reporte PowerPoint está disponible desde el plan Básico
    </div>
    <div style='color:#CCCCCC !important; font-size:12px; line-height:1.7; margin-bottom:16px;'>
    ...
    <a href="{STRIPE_BASICO}" target="_blank"
       ...
       color:#FFFFFF !important; font-weight:700; font-size:13px; padding:10px 22px;
       border-radius:8px; text-decoration:none;'>Obtener análisis completo — $99 MXN →</a>
</div>""", unsafe_allow_html=True)
...
<style>
  * {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .wrap {{ text-align: center; padding: 36px 32px 28px; background: #13243B; border-radius: 16px; color: white; }}
  ...
  .card {{ background: #20364F; border-radius: 12px; padding: 20px 18px;
...
<div class="wrap">
  ...
  <div class="cards">
    ...
    <div class="card card-basico">
      <div>
        <div class="tag" style="color:#6B7683;">BÁSICO</div>
