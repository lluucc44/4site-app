...
<div style='background:#13243B; border-radius:12px; padding:20px 24px; margin:10px 0;'>
    <div style='color:#2A6FDB; font-weight:700; font-size:15px; margin-bottom:8px;'>
        🔒 El reporte PowerPoint está disponible desde el plan Básico
    </div>
    <div style='color:#CCCCCC; font-size:12px; line-height:1.7; margin-bottom:16px;'>
    ...
    <a href="{STRIPE_BASICO}" target="_blank"
       ...
       color:#13243B; font-weight:700; font-size:13px; padding:10px 22px;
