...
try:
    ...
    PPTX_OK = True
except Exception as _pptx_import_err:
    PPTX_OK = False
    _generar_pptx_por_tier = None
    _PPTX_ERROR = str(_pptx_import_err)
...
/* Forzar esquema claro: evita que el modo oscuro del telefono invierta colores */
:root { color-scheme: light only !important; }
html, body, .stApp { color-scheme: light only !important; }
...
/* Radio sidebar */
[data-testid="stSidebar"] [data-testid="stRadio"] label { color: #13243B !important; }
...
div.stButton > button[data-testid="baseButton-primary"] {
    ...
    box-shadow: 0 2px 10px rgba(42,111,219,0.25) !important;
    transition: all 0.2s !important;
}
div.stButton > button[kind="primary"]:hover {
    background: #1F5FC2 !important;
    box-shadow: 0 4px 16px rgba(42,111,219,0.35) !important;
}

/* Botón secundario — navy */
...
div.stButton > button:not([kind="primary"]):hover {
    background-color: #20364F !important;
}

/* ── Barras-acordeon claras (lista de negocios recomendados) ──
   Se apunta por la clase estable .st-key-btn_rec_N que Streamlit genera
   a partir del key del boton. Colores fijos + color-scheme light para que
   se vean igual en cualquier telefono, tenga o no modo oscuro activado. */
.st-key-btn_rec_0 button, .st-key-btn_rec_1 button, .st-key-btn_rec_2 button,
.st-key-btn_rec_3 button, .st-key-btn_rec_4 button, .st-key-btn_rec_5 button,
.st-key-btn_rec_6 button, .st-key-btn_rec_7 button, .st-key-btn_rec_8 button,
.st-key-btn_rec_9 button, .st-key-btn_rec_10 button, .st-key-btn_rec_11 button,
.st-key-btn_rec_12 button, .st-key-btn_rec_13 button, .st-key-btn_rec_14 button,
.st-key-btn_rec_15 button, .st-key-btn_rec_16 button, .st-key-btn_rec_17 button,
.st-key-btn_rec_18 button, .st-key-btn_rec_19 button, .st-key-btn_rec_20 button,
.st-key-btn_rec_21 button, .st-key-btn_rec_22 button, .st-key-btn_rec_23 button,
.st-key-btn_rec_24 button, .st-key-btn_rec_25 button, .st-key-btn_rec_26 button,
.st-key-btn_rec_27 button, .st-key-btn_rec_28 button, .st-key-btn_rec_29 button {
    ...
    -webkit-text-fill-color: #13243B !important;
}
.st-key-btn_rec_0 button:hover, .st-key-btn_rec_1 button:hover, .st-key-btn_rec_2 button:hover,
.st-key-btn_rec_3 button:hover, .st-key-btn_rec_4 button:hover, .st-key-btn_rec_5 button:hover,
.st-key-btn_rec_6 button:hover, .st-key-btn_rec_7 button:hover, .st-key-btn_rec_8 button:hover,
.st-key-btn_rec_9 button:hover, .st-key-btn_rec_10 button:hover, .st-key-btn_rec_11 button:hover,
.st-key-btn_rec_12 button:hover, .st-key-btn_rec_13 button:hover, .st-key-btn_rec_14 button:hover,
.st-key-btn_rec_15 button:hover, .st-key-btn_rec_16 button:hover, .st-key-btn_rec_17 button:hover,
.st-key-btn_rec_18 button:hover, .st-key-btn_rec_19 button:hover, .st-key-btn_rec_20 button:hover,
.st-key-btn_rec_21 button:hover, .st-key-btn_rec_22 button:hover, .st-key-btn_rec_23 button:hover,
.st-key-btn_rec_24 button:hover, .st-key-btn_rec_25 button:hover, .st-key-btn_rec_26 button:hover,
.st-key-btn_rec_27 button:hover, .st-key-btn_rec_28 button:hover, .st-key-btn_rec_29 button:hover {
...
[class*="st-key-btn_rec_"] button * {
    color: #13243B !important;
    -webkit-text-fill-color: #13243B !important;
}

/* Tabs */
.stTabs [data-baseweb="tab-list"] { gap: 4px; border-bottom: 1px solid #E2E8F0 !important; }
...
.stTabs [aria-selected="true"] {
    ...
    border-bottom: 3px solid #2A6FDB !important;
    font-weight: 700 !important;
}
...
.stTextInput input, .stSelectbox select {
    ...
    border: 1.5px solid #D5DEE8 !important;
    background: #FFFFFF !important;
    color: #13243B !important;
}
.stTextInput input:focus { border-color: #2A6FDB !important; box-shadow: 0 0 0 2px rgba(42,111,219,0.15) !important; }

/* Métricas */
[data-testid="stMetricValue"] { font-weight: 800 !important; font-family: 'Montserrat', sans-serif !important; color: #13243B !important; font-size: 1.6rem !important; }
[data-testid="stMetricLabel"] { font-family: 'Montserrat', sans-serif !important; color: #586676 !important; font-size: 11px !important; font-weight: 600 !important; text-transform: uppercase !important; letter-spacing: 0.06em !important; }
...
/* Divider */
hr { border-color: #E2E8F0 !important; opacity: 1; margin: 1rem 0; }

/* Info/Warning/Success boxes */
.stAlert { border-radius: 10px !important; font-family: 'Montserrat', sans-serif !important; }
[data-testid="stInfoBox"] { border-left: 3px solid #2A6FDB !important; background: #F0F6FF !important; }

/* Radio buttons */
.stRadio [data-testid="stMarkdownContainer"] p { font-family: 'Montserrat', sans-serif !important; }
/* Radio button color — azul 4SITE */
...
[data-testid="stWidgetLabel"] { color: #13243B !important; font-family: 'Montserrat', sans-serif !important; }
...
::-webkit-scrollbar-thumb { background: #2A6FDB; border-radius: 3px; }

/* ══════════════════════════════════════════════════════════════
   BLINDAJE ANTI-DARK-MODE
   Fuerza texto oscuro en TODA la app sin importar el tema del
   dispositivo. Las excepciones (cajas navy, tooltips, botones,
   inputs) se reintroducen después porque llevan fondo oscuro
   a propósito.
   ══════════════════════════════════════════════════════════════ */

/* 0) Fondo blanco en contenedores y columnas (evita franjas oscuras) */
...
/* 1) Barrido general: todo el texto del cuerpo va oscuro */
...
/* 2) Labels de radio y checkbox del CUERPO (los que desaparecían) */
[data-testid="stRadio"] label, [data-testid="stRadio"] label *,
[data-testid="stCheckbox"] label, [data-testid="stCheckbox"] label * {
    color: #13243B !important;
}

/* 3) Caption / texto tenue: gris legible, nunca blanco */
.stCaption, .stCaption *,
[data-testid="stCaptionContainer"], [data-testid="stCaptionContainer"] * {
    color: #586676 !important;
}

/* 4) Inputs: texto oscuro sobre fondo blanco, placeholder gris */
...
/* 5) Selectbox CERRADO (el control): fondo blanco + texto oscuro.
   En dark mode salía con fondo negro y texto blanco. */
...
[data-baseweb="select"] svg { fill: #586676 !important; }

/* 6) Dropdown desplegado del selectbox (menú de opciones) */
...
/* ── EXCEPCIONES: elementos con fondo oscuro que SÍ llevan texto claro ── */

/* Botones (fondo azul o navy) -> texto blanco */
div.stButton > button, div.stButton > button * {
    color: #FFFFFF !important;
}

/* Tooltips nativos de Streamlit (help=) -> texto blanco */
[data-baseweb="tooltip"], [data-baseweb="tooltip"] * {
    color: #FFFFFF !important;
}

/* (Selector global de "cajas oscuras" eliminado: la UI migró a fondos claros,
   así que ya no se fuerza texto blanco. Los pocos casos con fondo oscuro
   intencional definen su color inline con !important.) */

/* Hero sobre la foto: texto claro que debe ganar al barrido oscuro */
.hero-4site .hero-sub { color: #FFFFFF !important; }
.hero-4site .hero-tagline {
    color: #FFFFFF !important;
    font-weight: 700 !important;
    font-family: 'Montserrat', sans-serif !important;
}
...
TIPOS_NEGOCIO = {
    ...
    "tienda_importados":  {"nombre": "🍬 Tienda de Dulces / Productos Importados",  "keywords": ["importados","candy store","dulces","dulcería","dulceria","korean","japanese","snacks","imported"], "inversion_min": 150000, "inversion_max": 400000, "competencia_optima": 2, "descripcion": "Dulces y snacks importados (USA, Korea, Europa), dulcería de nicho"},
}
...
TYPE_MAPPING = {
    ...
    "tienda_importados":  ["store", "gift_shop", "grocery_or_supermarket"],
}
...
TICKET_DATOS_REALES = {
    ...
    "confiable": [
        ...
        "empanadas_antojitos","tienda_importados",
    ],
...
NEGOCIOS_PASO = {
    "alto":  ["comida_rapida","tienda_conveniencia",
              "panaderia","farmacia","servicios","empanadas_antojitos","tienda_importados"],
    "medio": ["cafe_premium","cafe_casual","restaurante_casual","bar","libreria","nutricion"],
    # cafe_premium y cafe_casual son semi-destino: el cliente puede ir en auto o a pie.
    # Penalizar SOLO por bajo peatonal es incorrecto — el acceso vehicular también los alimenta.
...
def obtener_demografia(lat, lng, direccion=""):
    ...
    La detección de municipio se hace por coordenadas (lat/lng), no por texto."""
    if MODULOS_OK and lat and lng:
        try:
            return obtener_datos_inegi(lat, lng, direccion or "", gmaps)
        except:
            pass
    # Fallback básico
    dem = {
...
def buscar_competencia_por_tipo(lat, lng, tipo_key, radio=500.0, tipo_plaza=None):
    ...
    try:
        resp = requests.post(url, headers=headers, json=data)
        if resp.status_code != 200:
            # La API falló (403 billing, 429 cuota, etc.): registrar, no dar 0 silencioso.
            try:
                import streamlit as _st
                _st.session_state["_places_error"] = f"HTTP {resp.status_code}: {resp.text[:200]}"
            except Exception:
                pass
            print(f"[buscar_competencia_por_tipo] HTTP {resp.status_code}: {resp.text[:200]}")
            return []
        ...
        for p in places:
            ...
            elif tipo_key in ("cafe_premium", "cafe_casual"):
                # "restaurant" se incluye en la búsqueda solo para no perder cafés
                # que Google clasifica como restaurant — pero NO basta solo ese tipo
                # genérico para contar como competencia (evita falsos positivos como
                # pizzerías, antojitos o pozole que también traen el tipo "restaurant").
                # Además: descartar gasolineras/tiendas que Google etiqueta con "cafe"
                # por su OXXO/minisuper interno (ej. PEMEX no es competencia de un café).
                _es_no_cafe = any(t in ["gas_station", "convenience_store",
                                        "supermarket", "grocery_store"] for t in tipos)
                _tiene_kw_cafe  = any(kw.lower() in nombre for kw in keywords)
                _es_tipo_cafe   = any(t in ["cafe", "coffee_shop", "bakery"] for t in tipos)
                if (_tiene_kw_cafe or _es_tipo_cafe) and not _es_no_cafe:
                    filtered.append(p)
        ...
        # No tragar el error en silencio: registrarlo para no confundir
        # "0 competidores reales" con "la búsqueda falló" (que daba score 100 falso).
        try:
            import streamlit as _st
            _st.session_state["_places_error"] = f"{type(e).__name__}: {e}"
        except Exception:
            pass
        print(f"[buscar_competencia_por_tipo] ERROR: {type(e).__name__}: {e}")
        return []
...
def ajustar_score_por_contexto(score_base, tipo_key, contexto):
    ...
    elif tipo_key == "tienda_importados":
        if zona == "comercial" or "plaza" in pois: score += 20
        elif zona == "paso": score += 10
        elif "escuela" in pois: score += 8
        elif zona == "residencial": score += 5
...
def ajustar_score_por_acceso_vehicular(score_base: int, tipo_key: str,
                                        tipo_flujo: str,
                                        tiene_estacionamiento: bool) -> tuple:
    """
    Ajusta el score cuando el cliente llega principalmente en vehiculo.

    tipo_flujo: 'peatonal' | 'vehicular' | 'mixto'
    tiene_estacionamiento: True si hay cajones propios o estacionamiento al frente

    Negocios de paso alto (farmacia, conveniencia): necesitan peatonal.
      Si flujo vehicular puro sin cajones, penalizar.
    Negocios medio (cafeterias, restaurantes): funcionan con vehicular + cajones.
      Premio si hay cajones, sin penalizacion extra por bajo peatonal.
    Negocios bajo/destino: vehicular es neutro o positivo.
    """
    if tipo_flujo == "peatonal":
        return score_base, ""

    score = score_base
    nota = ""
    dep = ("alto" if tipo_key in NEGOCIOS_PASO["alto"]
           else "medio" if tipo_key in NEGOCIOS_PASO["medio"]
           else "bajo")

    if tipo_flujo == "vehicular":
        if dep == "alto":
            if tiene_estacionamiento:
                score += 3
                nota = "Trafico vehicular con estacionamiento — captacion de paso aceptable con cajones."
            else:
                score -= 10
                nota = "Negocio de paso en zona vehicular sin cajones — cliente dificilmente se detiene."
        elif dep == "medio":
            if tiene_estacionamiento:
                score += 12
                nota = "Trafico vehicular moderado + cajones propios — modelo destino: el cliente llega en auto con intencion. La penalizacion por bajo peatonal no aplica en este escenario."
            else:
                score += 4
                nota = "Trafico vehicular — sin cajones propios el acceso es mas dificil, pero viable si hay estacionamiento publico cercano."
        else:
            if tiene_estacionamiento:
                score += 10
                nota = "Negocio destino con acceso vehicular y estacionamiento — condiciones optimas."
            else:
                score += 3
                nota = "Negocio destino con trafico vehicular. Verifica estacionamiento publico a menos de 100m."
    elif tipo_flujo == "mixto":
        if dep == "medio":
            if tiene_estacionamiento:
                score += 8
                nota = "Trafico mixto con cajones — capta clientes de paso peatonal y en auto."
            else:
                score += 4
                nota = "Trafico mixto — buena captacion peatonal; considera disponibilidad de estacionamiento."
        elif dep == "bajo":
            if tiene_estacionamiento:
                score += 6
                nota = "Trafico mixto con acceso vehicular facilitado — buen balance para negocio destino."
            else:
                score += 2
                nota = "Trafico mixto — acceso adecuado para este tipo de negocio."

    return max(0, min(100, int(score))), nota

def nivel_score(score, idioma="es"):
    if score >= 80:   return ("ALTO", "#1F9D57") if idioma == "es" else ("HIGH", "#1F9D57")
    elif score >= 65: return ("MEDIO-ALTO", "#3FA46B") if idioma == "es" else ("MEDIUM-HIGH", "#3FA46B")
    elif score >= 50: return ("MEDIO", "#D98A1F") if idioma == "es" else ("MEDIUM", "#D98A1F")
    else:             return ("BAJO", "#E0524A") if idioma == "es" else ("LOW", "#E0524A")
...
def generar_analisis_claude(ubicacion, competidores, idioma, modo, tipo_negocio=None, recomendaciones=None, tipo_plaza=None, info_plaza=None, tipo_flujo="peatonal", tiene_estacionamiento=False):
    if modo == "validar":
...
CONTEXTO DE ACCESO:
- Tipo de flujo dominante: {"Vehicular (la mayoría llega en auto)" if tipo_flujo == "vehicular" else "Mixto (peatonal y vehicular)" if tipo_flujo == "mixto" else "Peatonal (la mayoría llega a pie)"}
- Estacionamiento propio o cajones al frente: {"SÍ" if tiene_estacionamiento else "NO"}
{"INSTRUCCIÓN FLUJO VEHICULAR: Esta ubicación tiene tráfico predominantemente vehicular" + (" con cajones de estacionamiento propios. Esto es POSITIVO para este tipo de negocio — el cliente llega en auto con intención de compra. NO penalices por bajo tráfico peatonal: el modelo de captación es diferente (destino vs. paso). Reconoce esto como ventaja." if tiene_estacionamiento else " pero SIN cajones propios al frente. Esto puede dificultar que el cliente se detenga impulsivamente. Menciona la necesidad de estacionamiento cercano como factor crítico.") if tipo_flujo == "vehicular" else ""}
{"INSTRUCCIÓN FLUJO MIXTO: La zona recibe tanto tráfico peatonal como vehicular. Si hay estacionamiento, esto amplía el alcance de captación de clientes." if tipo_flujo == "mixto" else ""}
...
Sé específico. No inventes datos."""
        ...
        _flujo_label = {"vehicular": "Vehicular (mayoría llega en auto)", "mixto": "Mixto (peatonal y vehicular)", "peatonal": "Peatonal"}.get(tipo_flujo, "Peatonal")
        prompt = f"""Eres analista experto en ubicaciones comerciales.

UBICACIÓN: {ubicacion}

CONTEXTO DE ACCESO:
- Tipo de flujo dominante: {_flujo_label}
- Estacionamiento propio o cajones al frente: {"SÍ" if tiene_estacionamiento else "NO"}
{"INSTRUCCIÓN: El flujo es vehicular. Los scores YA fueron ajustados para premiar negocios que funcionan bien con tráfico en auto. Al analizar por qué el #1 lidera, menciona si el acceso vehicular es una ventaja específica para ese tipo de negocio. No menciones 'bajo tráfico peatonal' como desventaja si el modelo de negocio no lo requiere." if tipo_flujo == "vehicular" else ""}
{"INSTRUCCIÓN: Flujo mixto con estacionamiento. Los negocios con mayor captación combinada (paso + destino) están favorecidos en el ranking." if tipo_flujo == "mixto" and tiene_estacionamiento else ""}

TOP 5 negocios viables (por score, ya ajustados por tipo de acceso):
{json.dumps([{'tipo': r['nombre'], 'score': r['score'], 'competidores': r['num_competidores']} for r in top5], indent=2, ensure_ascii=False)}

Responde en {idioma}:
**Análisis de la zona:**
[2 líneas sobre el perfil comercial de esta ubicación considerando el tipo de acceso]

**Por qué el #1 lidera:**
[1-2 líneas específicas, menciona si el tipo de acceso favorece a este negocio]
...
def obtener_reviews_competidores(competidores, max_negocios=4, max_reviews_por_negocio=5):
    """
    Trae reseñas de texto de los competidores con más reviews (más data disponible)
    usando Place Details (New). Devuelve lista de dicts: nombre, rating, reviews=[texto,...]
    """
    if not competidores:
        return []
    top = sorted(competidores, key=lambda c: c.get('userRatingCount', 0), reverse=True)[:max_negocios]
    resultado = []
    for c in top:
        place_id = c.get('id')
        ...
        if place_id:
            try:
                ...
                resp = requests.get(url, headers=headers, params={"languageCode": "es"})
                if resp.status_code == 200:
                    revs = resp.json().get('reviews', [])[:max_reviews_por_negocio]
                    textos = [r.get('text', {}).get('text', '') for r in revs if r.get('text', {}).get('text')]
            except:
                pass
        resultado.append({"nombre": nombre, "rating": rating, "reviews": textos})
    return resultado


def generar_analisis_diferenciacion(tipo_negocio_nombre, competidores_reviews, idioma):
    """
    Usa las reseñas reales de los competidores para identificar qué destaca
    la gente (servicio, precio, sabor/calidad, ambiente) y sugerir cómo
    un nuevo negocio puede diferenciarse e integrarse competitivamente.
    """
    con_reviews = [c for c in competidores_reviews if c.get("reviews")]
    if not con_reviews:
        return None
    bloque = json.dumps(
        [{"nombre": c["nombre"], "rating": c["rating"], "reviews": c["reviews"]} for c in con_reviews],
        indent=2, ensure_ascii=False
    )
    prompt = f"""Eres consultor de estrategia competitiva para un nuevo {tipo_negocio_nombre} que está evaluando entrar a esta zona.

Aquí tienes reseñas reales de Google Maps de los competidores cercanos:
{bloque}

Analiza qué destacan y qué critican los clientes de CADA competidor (servicio, precio, sabor/calidad del producto, ambiente/lugar, limpieza, rapidez, etc.).

Responde en {idioma} con este formato EXACTO:
**Lo que la gente valora de la competencia:**
- [competidor]: [qué destacan, en 1 línea]
- [competidor]: [qué destacan, en 1 línea]

**Lo que la gente critica:**
- [competidor]: [queja principal, en 1 línea]

**🎯 Cómo diferenciarte:**
- [punto 1: qué igualar/ofrecer de lo que ya funciona en la zona]
- [punto 2: qué hueco o queja puedes resolver mejor que ellos]
- [punto 3: diferenciador concreto y accionable, no genérico]

Sé específico y basado solo en lo que dicen las reseñas. No inventes datos."""
    ...
    try:
        ...
        return f"Error al generar análisis de diferenciación: {e}"
...
# ============================================
# CLASIFICACIÓN DESTINO vs IMPULSO vs MIXTO
# ============================================
PERFIL_CAPTACION = {
    # Destino: cliente va a propósito, redes sociales reemplazan tráfico de paso
    "destino": [
        "cafe_premium", "restaurante_fino", "gimnasio_boutique", "gimnasio_regular",
        "yoga_wellness", "medicina_estetica", "nutricion", "tienda_importados",
        "acabados_hogar", "ferreteria", "guarderia",
    ],
    # Impulso: el cliente te descubre pasando, no busca activamente
    "impulso": [
        "farmacia", "tienda_conveniencia", "comida_rapida",
        "empanadas_antojitos", "servicios", "panaderia",
    ],
    # Mixto: funciona de ambas formas según contexto
    "mixto": [
        "cafe_casual", "restaurante_casual", "bar", "libreria",
    ],
}

PERFIL_CAPTACION_LABELS = {
    "destino": ("🎯 Negocio de Destino", "El cliente busca activamente el negocio. Las redes sociales y la reputacion digital reemplazan el trafico de paso. La vialidad importa menos que la accesibilidad."),
    "impulso": ("⚡ Negocio de Impulso", "El cliente te descubre al pasar. La visibilidad y el trafico peatonal/vehicular son criticos para la captacion organica."),
    "mixto":   ("🔄 Negocio Mixto", "Capta tanto clientes de paso como clientes que vienen a proposito. Funciona en distintos tipos de vialidad segun la estrategia de marketing."),
}

def get_perfil_captacion(tipo_key):
    for perfil, tipos in PERFIL_CAPTACION.items():
...
def generar_recomendacion_final(
    ...
    # Perfil de captación del negocio
    _perfil_cap      = get_perfil_captacion(tipo_negocio or "")
    _label_cap, _desc_cap = PERFIL_CAPTACION_LABELS.get(_perfil_cap, PERFIL_CAPTACION_LABELS["mixto"])
    _tipo_flujo_rec  = (contexto or {}).get("tipo_flujo", "peatonal")
    _tiene_estac_rec = (contexto or {}).get("tiene_estacionamiento", False)
    _nota_veh_rec    = (contexto or {}).get("nota_vehicular", "")

    datos_base = f"""
UBICACIÓN: {ubicacion}
TIPO DE NEGOCIO: {tipo_nombre}
INVERSIÓN REQUERIDA: ${inversion_min:,} – ${inversion_max:,} MXN
PERFIL DE CAPTACIÓN: {_label_cap} — {_desc_cap}
...
- Dependencia al tráfico de paso: {((contexto or {}).get('analisis_vial') or {}).get('dependencia_paso', 'medio')}"""
    ...
    # ── Acceso vehicular + factor digital ──
    _bloque_vehicular = ""
    if _tipo_flujo_rec != "peatonal" or _tiene_estac_rec:
        _flujo_label_rec = {"vehicular": "Vehicular (mayoria llega en auto)", "mixto": "Mixto", "peatonal": "Peatonal"}.get(_tipo_flujo_rec, "Peatonal")
        _bloque_vehicular = f"""

ACCESO Y ESTACIONAMIENTO:
- Tipo de flujo dominante en la zona: {_flujo_label_rec}
- Cajones / estacionamiento propio al frente: {"SI" if _tiene_estac_rec else "NO"}
{f"- Impacto vehicular en score: {_nota_veh_rec}" if _nota_veh_rec else ""}"""

    # Factor digital — solo para negocios destino
    _bloque_digital = ""
    if _perfil_cap == "destino":
        _digital_estac = (
            "Con cajones de estacionamiento propios, el modelo digital-destino es viable: el cliente llega en auto desde fuera de la zona atraido por redes sociales."
            if _tiene_estac_rec else
            "SIN cajones propios esto es un riesgo critico: el cliente de destino digital que viene en auto no podra detenerse facilmente. Mencionalo como condicion necesaria para que el modelo funcione."
        )
        _bloque_digital = f"""

FACTOR DIGITAL (aplica a negocios destino):
- Este tipo de negocio puede captar clientes fuera de la zona inmediata via redes sociales (Instagram/TikTok).
- La penalizacion por vialidad local o bajo trafico peatonal se reduce si el negocio tiene presencia digital activa.
- {_digital_estac}
INSTRUCCION: Incluye una seccion 📱 Factor Digital en tu recomendacion final explicando como las redes sociales cambian el modelo de captacion para este negocio y que condiciones fisicas (estacionamiento, visibilidad) son necesarias para que ese modelo funcione."""

    datos_base += _bloque_vehicular + _bloque_digital
...
- Ticket promedio del negocio: ${mercado_data.get('ticket_promedio',0):,} MXN (usar este dato — no calcular desde otras cifras)
- Ingreso operativo estimado: ${mercado_data.get('ingreso_operativo_mensual',0):,} MXN/mes ({mercado_data.get('clientes_dia_estimados',0)} clientes × ${mercado_data.get('ticket_promedio',0):,} ticket × {mercado_data.get('dias_operacion',26)} días) — este es el ingreso real esperado del negocio, diferente al mercado potencial total"""

    if forecast_data:
        esc = forecast_data.get('escenarios', {})
        datos_pro += f"""
FORECAST DE VENTAS:
- Pesimista: ${esc.get('pesimista',{}).get('promedio_mensual',0):,}/mes (${esc.get('pesimista',{}).get('total_anual',0):,} año 1)
- Base: ${esc.get('base',{}).get('promedio_mensual',0):,}/mes (${esc.get('base',{}).get('total_anual',0):,} año 1)
- Optimista: ${esc.get('optimista',{}).get('promedio_mensual',0):,}/mes (${esc.get('optimista',{}).get('total_anual',0):,} año 1)"""
...
**🛣️ Factibilidad vial:**
[2 líneas: tipo de vialidad, impacto en score, y si es {_label_cap} — explica cómo el perfil de captación cambia la lectura de la vialidad]

**📱 Factor digital:**
[Si es negocio DESTINO: explica cómo redes sociales reemplazan el tráfico de paso, qué condiciones físicas necesita (estacionamiento, visibilidad), y si con presencia digital activa el veredicto cambia. Si es negocio IMPULSO: indica que el factor digital NO reemplaza la visibilidad física en este tipo de negocio.]

**🎯 VEREDICTO: [PROCEDER ✅ / PRECAUCIÓN 🟡 / NO PROCEDER ❌]**
[2-3 líneas. Si es negocio destino, menciona dos escenarios: SIN estrategia digital vs CON estrategia digital activa cuando aplique]
...
**🛣️ Factibilidad vial:**
[2 líneas: tipo de vialidad, impacto en score. Menciona si es {_label_cap} y cómo eso afecta la lectura]

**📱 Factor digital:**
[1 línea: si es negocio destino, menciona que las redes sociales pueden compensar la vialidad. Si es impulso, que no aplica.]

**🎯 VEREDICTO: [PROCEDER ✅ / PRECAUCIÓN 🟡 / NO PROCEDER ❌]**
[1-2 líneas de justificación incluyendo el factor vial y perfil de captación]
...
def _bloque_narrativa_pdf(narrativa, s):
    ...
    narr_tbl.setStyle(TableStyle([
        ...
        ('BOX', (0,0), (-1,-1), 0.5, colors.HexColor('#13243B44')),
    ]))
    # Texto dentro de la caja
    narr_para = Paragraph(
        f'<font color="#13243B">💬</font> <i>{narrativa}</i>',
...
def _estilos_pdf():
    ...
    _N = colors.HexColor("#13243B")   # negro
    _D = colors.HexColor("#2A6FDB")   # dorado
    ...
    if upgrades:
        ...
        for nombre, desc in upgrades:
            ...
            nombre_p = _P(f"<b>{nombre}</b>",
                ...
                fontSize=9, textColor=colors.HexColor('#2A6FDB')))
            desc_p = _P(desc,
...
def _portada_foto_canvas(output_canvas, ubicacion, score, tier_key,
    ...
    _SC = (colors.HexColor("#1F9D57") if score>=65 else
           colors.HexColor("#D98A1F") if score>=40 else
           colors.HexColor("#E0524A"))
...
def generar_pptx_zona_potencial(resultados, ubicacion_ref, radio_km,
    ...
    C = {
        "dorado": "2A6FDB", "verde": "1F9D57", "azul": "2A6FDB",
        "amarillo": "D98A1F", "rojo": "E0524A", "blanco": "FFFFFF",
        "oscuro": "20364F", "gris_t": "6B6B6B", "gris_c": "F5F5F5",
    ...
    def interp(sl, y, text, h=0.55):
        box(sl, 0.3, y, 12.7, h, "F0F6FF", C["dorado"], 0.7)
    ...
    for ri, (label, texto) in enumerate(rec_items):
        ...
        if ri == 0 and recom1.get("ref_competidor"):
            ...
            box(sl, 6.75, ry, 6.28, 0.78, C["blanco"], C["gris_b"], 0.4)
            box(sl, 6.75, ry, 0.06, 0.78, "1F9D57")
        ...
        with st.spinner(f"Analizando zona de {radio_km:.0f} km a la redonda..."):
            try:
                ...
                <div style='display:grid; grid-template-columns:1fr 1fr; gap:10px;'>
                    <div style='background:#E8F8F0; border-left:3px solid #1F9D57;
                    ...
                    <div style='background:#EBF5FF; border-left:3px solid #2A6FDB;
                         border-radius:6px; padding:8px 12px;'>
                ...
                for i, res in enumerate(_top3):
                    _sc = res["score"]
                    _ch = "#1F9D57" if _sc>=65 else "#D98A1F" if _sc>=40 else "#E0524A"
                    ...
                    <div style='border:1px solid #C8E6C9; border-left:5px solid {_ch};
                      ...
                      <div style='display:flex; justify-content:space-between; align-items:flex-start;'>
                        <div style='flex:1;'>
                          <div style='font-size:14px; font-weight:800; color:#20364F; margin-bottom:4px;'>
                            #{i+1} — {_dir_safe}</div>
                          <span style='font-size:11px; background:#1F9D5722; color:#1A7A44;
                ...
                for i, res in enumerate(_top456):
                    _sc = res["score"]
                    _ch = "#2A6FDB" if _sc>=50 else "#D98A1F" if _sc>=35 else "#E0524A"
                    _recom = res.get("recom_ubicacion", {})
                    ...
                    <div style='border:1px solid #BBDEFB; border-left:5px solid {_ch};
                      ...
                      <div style='display:flex; justify-content:space-between; align-items:flex-start;'>
                        <div style='flex:1;'>
                          ...
                          <span style='font-size:11px; background:#2A6FDB22; color:#1A4A7A;
                    ...
                    try:
                        ...
                        for _ri, res in enumerate(resultados[:8]):
                            ...
                            _popup_html = (
                                ...
                                f"<b style='font-size:15px; color:{'#1F9D57' if _sc2>=65 else '#D98A1F' if _sc2>=40 else '#E0524A'};'>"
                ...
                st.markdown("---")
                st.markdown("""
                <div style='background:#FFFFFF; border:1px solid #E3E8EF; border-radius:12px; padding:20px 24px; color:#13243B;'>
                <p style='font-size:13px; font-weight:700; color:#2A6FDB; margin:0 0 10px;'>
                ...
                <div style='display:grid; grid-template-columns:1fr 1fr 1fr; gap:12px; margin-top:8px;'>
                    <div style='background:#F5F7FA; border-radius:8px; padding:12px;'>
                        <div style='color:#2A6FDB; font-weight:700; font-size:12px; margin-bottom:4px;'>🎫 Ticket promedio</div>
                        <div style='color:#5C6B7A; font-size:11px;'>Ajusta tu precio al nivel socioeconómico y competencia de la zona. Un ticket mal calibrado puede cancelar una buena ubicación.</div>
                    </div>
                    <div style='background:#F5F7FA; border-radius:8px; padding:12px;'>
                        <div style='color:#2A6FDB; font-weight:700; font-size:12px; margin-bottom:4px;'>🤝 Atención al cliente</div>
                        <div style='color:#5C6B7A; font-size:11px;'>En zonas con competencia cercana, la experiencia del cliente es el diferenciador principal. El rating en Google impacta directamente en la captación.</div>
                    </div>
                    <div style='background:#F5F7FA; border-radius:8px; padding:12px;'>
                        <div style='color:#2A6FDB; font-weight:700; font-size:12px; margin-bottom:4px;'>📱 Presencia en redes</div>
                        <div style='color:#5C6B7A; font-size:11px;'>Una buena ubicación sin visibilidad digital pierde clientes. Google Maps, Instagram y WhatsApp Business son esenciales para convertir tráfico de paso en clientes recurrentes.</div>
                    </div>
                </div>
                </div>""", unsafe_allow_html=True)
...
def _seccion_pdf(titulo, icono, s, color=None):
    ...
    _color = color or s.get("_N", colors.HexColor("#13243B"))
    return [
        Spacer(1, 0.12 * inch),
        Table(
...
def _kpi_pdf(kpis, s, col_w=None):
    ...
    for i, k in enumerate(kpis):
        ...
        bg = colors.HexColor("#F0F6FF") if k.get("gold") else colors.HexColor("#F5F5F5")
...
def _tabla_pdf(filas, col_widths, s, header_color=None):
    ...
    hc = header_color or s.get("_N", colors.HexColor("#13243B"))
...
def _footer_pdf(canvas_obj, doc_obj):
    ...
    canvas_obj.setStrokeColor(colors.HexColor("#2A6FDB"))
...
def generar_pdf_free(ubicacion, score, desglose, analisis, competidores,
    ...
    if av_f:
        ...
        color_f = '#1F9D57' if ajuste_f > 0 else '#E0524A' if ajuste_f < -5 else '#FF9800'
        story.append(Paragraph(
    ...
    story.append(Paragraph(
        ...
        ParagraphStyle('upsell_f', parent=s["base"]['Normal'], fontSize=8.5,
            textColor=colors.HexColor('#2A6FDB'), fontName='Helvetica-Oblique')))
...
def generar_pdf_basic(ubicacion, score, desglose, analisis, competidores,
    ...
    if av_b and av_b.get("descripcion"):
        ...
        color_b  = '#1F9D57' if ajuste_b > 0 else '#E0524A' if ajuste_b < -5 else '#FF9800'
...
def generar_pdf_pro(ubicacion, score, desglose, analisis, competidores,
    ...
    if MODULOS_OK and demografia and tipo_negocio_efectivo:
        try:
            ...
            mercado_data  = calcular_mercado_potencial(demografia, tipo_negocio_efectivo, len(competidores or []), competidores)
    ...
    if av_pdf and av_pdf.get("descripcion"):
        ...
        color_v  = '#1F9D57' if ajuste_v > 0 else '#E0524A' if ajuste_v < -5 else '#FF9800'
        vial_rows = [
    ...
    if ticket_data:
        ...
        story.append(Spacer(1, 0.08*inch))
        _kpi_t = ParagraphStyle('kpit',parent=s["base"]['Normal'],fontSize=24,fontName='Helvetica-Bold',textColor=colors.HexColor('#2A6FDB'),alignment=TA_CENTER)
...
def generar_pdf_premium(ubicacion, score, desglose, analisis, competidores,
    ...
    if av_prem and av_prem.get("descripcion"):
        ...
        color_prem  = '#1F9D57' if ajuste_prem > 0 else '#E0524A' if ajuste_prem < -5 else '#FF9800'
    ...
    if ticket_data:
        ...
        story.append(Spacer(1,0.08*inch))
        _kpi_t2 = ParagraphStyle('kpit2',parent=s["base"]['Normal'],fontSize=22,fontName='Helvetica-Bold',textColor=colors.HexColor('#2A6FDB'),alignment=TA_CENTER)
        _kpi_r2 = ParagraphStyle('kpir2',parent=s["base"]['Normal'],fontSize=22,fontName='Helvetica-Bold',textColor=colors.HexColor('#1F9D57'),alignment=TA_CENTER)
...
_img_path = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), "hero_4site.jpg")
_img_b64 = ""
...
st.markdown(f"""
<div class='hero-4site' style='position:relative; border-radius:16px; overflow:hidden; margin-bottom:16px; min-height:260px;'>
    {'<img src="data:image/jpeg;base64,' + _img_b64 + '" style="position:absolute; top:0; left:0; width:100%; height:100%; object-fit:cover; object-position:center;" />' if _img_b64 else ''}
    <div style='position:absolute; top:0; left:0; width:100%; height:100%;
         background:linear-gradient(180deg, rgba(0,0,0,0.25) 0%, rgba(0,0,0,0.65) 100%);'></div>
    <div style='position:relative; z-index:2; text-align:center; padding:56px 20px 48px;'>
        <p class='hero-tagline' style='font-size:16px; margin:0 0 10px; font-style:italic;
             font-weight:700; font-family:Montserrat,sans-serif;'>Don't guess. Foresee.</p>
        <p class='hero-sub' style='font-size:15px; margin:0 auto; max-width:460px; line-height:1.7;
             text-shadow:0 1px 4px rgba(0,0,0,0.9);'>
            Descubre si tu ubicación tiene potencial para tu negocio antes de invertir — en minutos.
        </p>
    </div>
</div>
""", unsafe_allow_html=True)
...
st.markdown(
    """
<div style="background:#F9F9F9; border:1px solid #EBEBEB; border-radius:14px;
     padding:16px 20px; margin:12px auto 8px; max-width:560px;">
    <p style="font-size:10px; color:#999; margin:0 0 10px; text-transform:uppercase; letter-spacing:0.6px;">
        Ejemplo de análisis real
    </p>
    <div style="display:flex; align-items:center; gap:16px; margin-bottom:12px;">
        <div style="text-align:center; min-width:64px;">
            <span style="font-size:38px; font-weight:700; color:#3B6D11; line-height:1;">82</span>
            <div style="font-size:10px; color:#888; margin-top:2px;">/100</div>
        </div>
        <div>
            <p style="font-size:13px; font-weight:600; color:#13243B; margin:0 0 2px;">Alto potencial ✅</p>
            <p style="font-size:11px; color:#888; margin:0;">☕ Cafetería · Insurgentes Sur, CDMX</p>
            <p style="font-size:11px; color:#888; margin:2px 0 0;">🛣️ Vialidad principal · +25 pts</p>
        </div>
    </div>
    <div style="display:flex; gap:6px; flex-wrap:wrap;">
        <span style="font-size:10px; background:#EAF3DE; color:#3B6D11; padding:3px 10px; border-radius:99px;">Alta densidad</span>
        <span style="font-size:10px; background:#EAF3DE; color:#3B6D11; padding:3px 10px; border-radius:99px;">NSE A/B</span>
        <span style="font-size:10px; background:#FAEEDA; color:#854F0B; padding:3px 10px; border-radius:99px;">3 competidores</span>
        <span style="font-size:10px; background:#EAF3DE; color:#3B6D11; padding:3px 10px; border-radius:99px;">Mercado activo</span>
    </div>
    <p style="font-size:10px; color:#2A6FDB; margin:10px 0 0; font-style:italic;">
        🔒 Desglose completo, NSE, forecast y reporte PowerPoint disponibles desde $99 MXN
    </p>
</div>
    """,
    unsafe_allow_html=True
...
col_gratis, _ = st.columns([1, 2])
with col_gratis:
    if st.button("🔍 Analizar mi ubicación gratis", use_container_width=True, type="primary"):
        st.session_state.tier_activo = "free"

# Link secundario para código
st.markdown("""
<p style='font-size:12px; color:#888; margin:4px 0 0;'>
    ¿Ya compraste? <a href='#' style='color:#2A6FDB;'>Ingresa tu código arriba</a>
</p>
""", unsafe_allow_html=True)

# Mostrar tier activo (solo si tiene código activo — no mostrar en free por default)
...
if tier_key in ["pro", "premium", "premium2"]:
    ...
    if _tipo_plaza_detectado in ["mall", "strip_center", "plaza_ambigua"]:
        ...
        st.markdown(f"""<div style='background:#F5F7FA; border-left:4px solid #D98A1F;
            border-radius:6px; padding:8px 14px; margin:2px 0 6px;'>
            <span style='color:#D98A1F; font-size:12px;'>{_det_labels[_tipo_plaza_detectado]}
    ...
    with _col_pz2:
        if tipo_plaza == "mall":
            st.markdown("""<div style='background:#F5F7FA; border-left:3px solid #2A6FDB;
                border-radius:6px; padding:8px 12px; font-size:11px; color:#5C6B7A;'>
                <b style='color:#2A6FDB;'>Mall cerrado</b><br>
    ...
    if _tipo_plaza_detectado == "mall":
        tipo_plaza = "mall"
        st.markdown("""<div style='background:#F5F7FA; border-left:4px solid #2A6FDB;
            border-radius:6px; padding:10px 14px; margin:4px 0 8px;'>
            <span style='color:#2A6FDB; font-weight:700;'>🏬 Mall / Plaza Cerrada detectado</span><br>
            <span style='color:#5C6B7A; font-size:12px;'>
        ...
        st.markdown("""<div style='background:#F5F7FA; border-left:4px solid #2A6FDB;
            border-radius:6px; padding:10px 14px; margin:4px 0 8px;'>
            <span style='color:#2A6FDB; font-weight:700;'>🏪 Strip Center / Plaza Abierta detectada</span><br>
            <span style='color:#5C6B7A; font-size:12px;'>
            Análisis con lógica de plaza abierta.</span>
            </div>""", unsafe_allow_html=True)
    elif _tipo_plaza_detectado == "plaza_ambigua" and direccion_texto:
        st.markdown("""<div style='background:#F5F7FA; border-left:4px solid #D98A1F;
            border-radius:6px; padding:10px 14px; margin:4px 0 8px;'>
            <span style='color:#D98A1F; font-weight:700;'>🏢 ¿Qué tipo de plaza es?</span><br>
            <span style='color:#5C6B7A; font-size:12px;'>
...
if tipo_plaza == "mall":
    ...
    with _col_sc2:
        ...
        if ancla_strip in _tips_ancla:
            st.markdown(f"""<div style='background:#F5F7FA; border-left:3px solid #2A6FDB;
                border-radius:6px; padding:8px 12px; font-size:11px; color:#5C6B7A; margin-top:22px;'>
...
# ── FLUJO DE ACCESO Y ESTACIONAMIENTO ────────────────────────────────────────
st.markdown("**¿Cómo llegan principalmente los clientes a esta zona?**")
_col_flujo1, _col_flujo2 = st.columns([3, 2])
with _col_flujo1:
    _tipo_flujo_sel = st.radio(
        "",
        options=["peatonal", "vehicular", "mixto"],
        format_func=lambda x: {
            "peatonal":  "🚶 Principalmente a pie — zona peatonal o mucho tránsito caminando",
            "vehicular": "🚗 Principalmente en auto — la mayoría llega en vehículo",
            "mixto":     "🚶🚗 Mixto — hay tanto peatones como autos",
        }.get(x, x),
        index=0,
        key="tipo_flujo_radio",
        horizontal=False,
        label_visibility="collapsed",
    )
...
with _col_flujo2:
    _tips_flujo = {
        "peatonal":  "La ubicación depende de la visibilidad y el paso constante de personas. Zonas como centros, mercados o corredores comerciales.",
        "vehicular": "El cliente llega con intención. Necesitas visibilidad desde la calle y acceso fácil para entrar y salir.",
        "mixto":     "Buen balance: la ubicación puede captar tanto clientes de paso como clientes que vienen a propósito.",
    }
    st.markdown(f"""<div style='background:#F5F7FA; border-left:3px solid #2A6FDB;
        border-radius:6px; padding:10px 14px; font-size:11px; color:#5C6B7A !important; margin-top:22px; line-height:1.6;'>
        {_tips_flujo.get(_tipo_flujo_sel,"")}</div>""", unsafe_allow_html=True)

_tiene_estac = st.checkbox(
    "🅿️ El local tiene cajones de estacionamiento propios o estacionamiento al frente",
    value=False,
    key="tiene_estacionamiento_check"
)
st.session_state["tipo_flujo"]            = _tipo_flujo_sel
st.session_state["tiene_estacionamiento"] = _tiene_estac
...
try:
    ...
    mapa_data = st_folium(m, width=700, height=350, key=f"mapa_folium_{tier_key}")
...
if tier_key == "free":
    ...
    if tier_key == "premium2":
        ...
        if modo == "zona_potencial":
            ...
            st.markdown("""<div style='background:#FFFFFF; border:1px solid #E3E8EF; border-radius:10px;
                padding:12px 18px; margin:6px 0;'>
                <span style='color:#2A6FDB; font-weight:700;'>🔍 Identificar Zona Potencial</span><br>
                <span style='color:#5C6B7A; font-size:12px;'>
        ...
        if modo == "zona_potencial":
            st.markdown("""<div style='background:#FFFFFF; border:1px solid #E3E8EF; border-radius:10px;
                padding:12px 18px; margin:6px 0;'>
                <span style='color:#2A6FDB; font-weight:700;'>🔍 Descubrir Zona Potencial — PREMIUM 💎</span><br>
                <span style='color:#5C6B7A; font-size:12px;'>
                Ingresa un punto de referencia y encontraremos las mejores zonas
                para tu negocio en el radio que elijas.</span>
                </div>""", unsafe_allow_html=True)
...
if modo == "zona_potencial":
    ...
    st.markdown("---")
    st.markdown("""
    <div style='background:#F5F7FA; border:2px solid #2A6FDB; border-radius:12px;
         padding:28px 32px; margin:12px 0; text-align:center;'>
        <div style='font-size:32px; margin-bottom:10px;'>🔧</div>
        <div style='color:#2A6FDB; font-weight:700; font-size:18px; margin-bottom:8px;'>
            Zona Potencial — En mantenimiento</div>
        <div style='color:#5C6B7A; font-size:13px; line-height:1.6; margin-bottom:16px;'>
        ...
        <div style='color:#888; font-size:11px;'>
            Mientras tanto usa los modos <b style="color:#2A6FDB">Validar negocio</b> o
            <b style="color:#2A6FDB">Descubrir negocio</b> para analizar ubicaciones específicas.
        </div>
    </div>""", unsafe_allow_html=True)
    st.stop()
...
if st.button(t["boton_analizar"], type="primary", use_container_width=True):
    ...
    # Nuevos inputs de acceso vehicular
    _tipo_flujo           = st.session_state.get("tipo_flujo", "peatonal")
    _tiene_estacionamiento = st.session_state.get("tiene_estacionamiento", False)
    ...
    with st.spinner("🔍 Analizando ubicación..."):
        ...
        if modo == "validar":
            ...
            # Ajuste por tipo de plaza
            score_plaza, info_plaza = ajustar_score_por_plaza(
                score_dem, tipo_negocio_seleccionado,
                _tipo_plaza, _zona_mall, _renta_mall, _ancla_strip
            )
            # Ajuste por acceso vehicular y estacionamiento (nuevo)
            score, nota_vehicular = ajustar_score_por_acceso_vehicular(
                score_plaza, tipo_negocio_seleccionado,
                _tipo_flujo, _tiene_estacionamiento
            )
            # Guardar en contexto para reportes y prompt de Claude
            if _tipo_plaza:
                contexto["info_plaza"] = info_plaza
            contexto["tipo_flujo"]            = _tipo_flujo
            contexto["tiene_estacionamiento"] = _tiene_estacionamiento
            contexto["nota_vehicular"]         = nota_vehicular
            if nota_vehicular:
                contexto["badges"].append("🚗 Tráfico vehicular" if _tipo_flujo == "vehicular"
                                          else "🚶🚗 Tráfico mixto" if _tipo_flujo == "mixto"
                                          else "🚶 Tráfico peatonal")
            ...
            analisis    = generar_analisis_claude(ubicacion, competidores, idioma, "validar",
                                                  ...
                                                  tipo_flujo=_tipo_flujo,
                                                  tiene_estacionamiento=_tiene_estacionamiento)
            ...
            # Aplicar ajuste vehicular a CADA recomendación
            for rec in (recomendaciones or []):
                rec["score"], rec["nota_vehicular"] = ajustar_score_por_acceso_vehicular(
                    rec["score"], rec.get("tipo_key", ""),
                    _tipo_flujo, _tiene_estacionamiento
                )
                rec["score"] = max(0, min(100, rec["score"]))
            # Reordenar después del ajuste vehicular (puede cambiar el ranking)
            if recomendaciones:
                recomendaciones.sort(key=lambda x: x["score"], reverse=True)
            ...
            if tipo_negocio_top1:
                ...
                if _tipo_plaza:
                    contexto["tipo_plaza"] = _tipo_plaza
            # Inyectar acceso vehicular en contexto
            contexto["tipo_flujo"]            = _tipo_flujo
            contexto["tiene_estacionamiento"] = _tiene_estacionamiento
            nota_veh_top1 = recomendaciones[0].get("nota_vehicular", "") if recomendaciones else ""
            contexto["nota_vehicular"] = nota_veh_top1
            if nota_veh_top1 and _tipo_flujo != "peatonal":
                contexto["badges"].append("🚗 Tráfico vehicular" if _tipo_flujo == "vehicular" else "🚶🚗 Tráfico mixto")
...
if "resultados" in st.session_state:
    ...
    if av_data and av_data.get("descripcion"):
        ...
        color_vial = "#1F9D57" if av_data["ajuste_score"] > 0 else "#E0524A" if av_data["ajuste_score"] < -5 else "#D98A1F"
        st.markdown(f"""
    ...
    # ── NOTA DE ACCESO VEHICULAR — visible en todos los tiers ──
    _nota_veh = contexto.get("nota_vehicular", "") if contexto else ""
    _tipo_flujo_ctx = contexto.get("tipo_flujo", "peatonal") if contexto else "peatonal"
    _estac_ctx = contexto.get("tiene_estacionamiento", False) if contexto else False
    if _nota_veh and _tipo_flujo_ctx != "peatonal":
        _color_veh = "#1F9D57" if _estac_ctx else "#D98A1F"
        _icono_veh = "🚗" if _tipo_flujo_ctx == "vehicular" else "🚶🚗"
        st.markdown(f"""
        <div style='background:{_color_veh}11; border-left:4px solid {_color_veh};
             padding:10px 14px; border-radius:0 8px 8px 0; margin:8px 0;'>
            <b style='color:{_color_veh};'>{_icono_veh} Acceso vehicular</b><br>
            <span style='font-size:12px; color:#444;'>{_nota_veh}</span>
        </div>""", unsafe_allow_html=True)
    ...
    if tier_info["muestra_score_desglose"] and desglose:
        ...
        if _ip and _ip.get("tipo_plaza"):
            ...
            _pl_color = "#2A6FDB" if _ip["tipo_plaza"] == "mall" else "#2A6FDB"
            _pl_notas = _ip.get("nota", "").replace("\n", "<br>")
            _pl_roi   = _ip.get("ajuste_roi_pct", 0)
            st.markdown(f"""
            <div style='background:#F5F7FA; border-left:4px solid {_pl_color};
                 border-radius:8px; padding:12px 16px; margin:10px 0;'>
                <div style='color:{_pl_color}; font-weight:700; font-size:13px; margin-bottom:6px;'>
                    {_pl_label} — Impacto en el análisis</div>
                <div style='color:#5C6B7A; font-size:12px; line-height:1.6;'>{_pl_notas}</div>
                {"<div style='color:#D98A1F; font-size:11px; margin-top:6px;'>⚠️ El ROI estimado ya incluye una reducción de ~" + str(_pl_roi) + "% por renta de plaza.</div>" if _pl_roi > 0 else ""}
            </div>""", unsafe_allow_html=True)
        ...
        # ── FREE: liberar competencia real como gancho (dato ya calculado) ──
        _n_comp   = desglose.get("num_competidores", 0) if desglose else 0
        _rating   = desglose.get("rating_promedio", 0) if desglose else 0
        _dens     = desglose.get("densidad", 0) if desglose else 0

        # Etiqueta de saturación derivada del score de densidad ya calculado
        if _dens >= 80:
            _sat_txt, _sat_col = "Baja", "#1F9D55"
        elif _dens >= 60:
            _sat_txt, _sat_col = "Media", "#D98A1F"
        elif _dens >= 40:
            _sat_txt, _sat_col = "Media-alta", "#E8730C"
        else:
            _sat_txt, _sat_col = "Alta", "#D64545"

        _rating_txt = f"{_rating:.1f}★ promedio" if _rating else "sin rating relevante"

        st.markdown(f"""
<div style='background:#0F1E33 !important; border:1px solid #24405F; border-radius:12px;
     padding:18px 20px; margin:10px 0;'>
    <div style='display:flex; align-items:baseline; gap:10px; margin-bottom:10px;'>
        <span style='font-size:34px; font-weight:800; color:{_sat_col} !important; line-height:1;'>{_n_comp}</span>
        <span style='font-size:14px; color:#C9D6E5 !important;'>competidores directos de tu giro en 500m</span>
    </div>
    <div style='display:flex; gap:20px; flex-wrap:wrap; font-size:13px; color:#9FB2C8 !important;'>
        <span style='color:#9FB2C8 !important;'>Saturación aparente: <b style='color:{_sat_col} !important;'>{_sat_txt}</b></span>
        <span style='color:#9FB2C8 !important;'>Calidad de la competencia: <b style='color:#C9D6E5 !important;'>{_rating_txt}</b></span>
    </div>
    <div style='font-size:12px; color:#8698AE !important; margin-top:10px;'>
        ¿Dónde están exactamente y cuáles son tu amenaza real? El mapa de competidores
        y el desglose por factor están en el plan Básico.
    </div>
</div>""", unsafe_allow_html=True)
    ...
    if modo == "validar" and tier_key != "free":
        ...
        if tier_key in ("premium", "premium2") and competidores:
            _key_dif = "exp_dif_open"
            if _key_dif not in st.session_state: st.session_state[_key_dif] = False
            if st.button("Ver cómo diferenciarte de la competencia" + (" ▲" if st.session_state[_key_dif] else " ▼"), key="btn_dif_exp", use_container_width=True):
                st.session_state[_key_dif] = not st.session_state[_key_dif]
            if st.session_state[_key_dif]:
                if "_diferenciacion_txt" not in st.session_state:
                    with st.spinner("Analizando reseñas de la competencia..."):
                        _comp_reviews = obtener_reviews_competidores(competidores)
                        _nombre_tipo  = TIPOS_NEGOCIO.get(tipo_negocio_seleccionado, {}).get('nombre', 'negocio')
                        st.session_state["_diferenciacion_txt"] = generar_analisis_diferenciacion(
                            _nombre_tipo, _comp_reviews, idioma
                        )
                _dif_txt = st.session_state["_diferenciacion_txt"]
                if _dif_txt:
                    st.markdown(_dif_txt)
                else:
                    st.caption("No hay suficientes reseñas de texto en la competencia cercana para este análisis.")
    elif modo != "validar":
        ...
        for i, rec in enumerate(recomendaciones[:top_n]):
            ...
            _clic = st.button(f"#{i+1} {_exp_label} - Score: {rec['score']}/100" + _arrow,
    ...
    if tier_key in ["pro", "premium"] and MODULOS_OK and tipo_para_pro:
        ...
        for pico in trafico_data["horas_pico"]:
            color_p = "#1F9D57" if pico["flujo"] >= 80 else "#D98A1F" if pico["flujo"] >= 60 else "#9E9E9E"
        ...
        for hora, val in enumerate(trafico_data["trafico_horario"]):
            color_b = "#13243B" if val >= 70 else "#2A6FDB" if val >= 45 else "#E0E0E0"
        ...
        for i, (dia, val) in enumerate(zip(DIAS_SEMANA, trafico_data["trafico_semanal"])):
            color_d = "#13243B" if val >= 85 else "#2A6FDB" if val >= 65 else "#E0E0E0"
        ...
        mercado = calcular_mercado_potencial(demografia, tipo_para_pro, len(competidores), competidores)
        _mercado_flat = {
        ...
        if mercado.get("es_nicho"):
            dias_op = mercado.get("dias_operacion", 26)
            ticket_op = mercado.get("ticket_promedio", 0)
            clientes_op = mercado.get("clientes_dia_estimados", 0)
            ingreso_op = mercado["ingreso_operativo_mensual"]
            st.info(f"💰 **Ingreso operativo estimado: ${ingreso_op:,}/mes** — {clientes_op} clientes × ${ticket_op} ticket × {dias_op} días hábiles")
        st.caption(f"📐 Metodología: {mercado['metodologia']}")
        st.caption("⚠️ Es un estimado de mercado, no una cifra garantizada — puede variar según la capacidad/tamaño del local, tu estrategia en redes sociales y qué tan diferenciado seas frente a la competencia.")
        ...
        for col, escenario, color_e, emoji_e in [
            ...
            col.markdown(f"""<div style='background:{color_e}11; border:1px solid {color_e};
                ...
                <div style='font-size:22px; font-weight:bold; color:{color_e}; margin:6px 0;'>
                    ${datos_e["promedio_mensual"]:,}/mes</div>
                <div style='font-size:11px; color:#666;'>promedio mensual</div>
                <div style='font-size:13px; margin-top:6px; color:#888;'>
                    ${datos_e["total_anual"]:,} año 1</div>
                </div>""", unsafe_allow_html=True)
            ...
            try:
                ...
                for _i, _v in enumerate(_meses_fc):
                    ...
                    _html_fc += (f"<div style='flex:1;display:flex;flex-direction:column;align-items:center;'>"
                                 f"<div style='background:#2A6FDB;width:100%;height:{_pct}%;border-radius:3px 3px 0 0;min-height:3px;'></div>"
    ...
    if tier_key != "free":
        ...
        if tier_key in ["pro", "premium"] and MODULOS_OK:
            ...
            if _tipo_diag:
                try:
                    ...
                    _mercado_diag  = calcular_mercado_potencial(demografia, _tipo_diag, len(competidores), competidores)
        ...
        st.markdown(f"""
        <div style='background:linear-gradient(135deg,#13243B08 0%,#2A6FDB15 100%);
             border:2px solid #13243B55; border-radius:12px;
        ...
        st.markdown("""
        <div style='background:#FFFFFF; border:1px solid #E3E8EF; border-radius:12px; padding:18px 22px;
             color:#13243B; margin-top:12px;'>
        <p style='font-size:12px; font-weight:700; color:#2A6FDB; margin:0 0 10px;'>
            💡 La ubicación es el punto de partida — el éxito depende también de:</p>
        <div style='display:flex; gap:12px; flex-wrap:wrap;'>
            <div style='flex:1; min-width:160px; background:#F5F7FA; border-radius:8px; padding:10px 12px;'>
                <div style='color:#2A6FDB; font-weight:700; font-size:11px;'>🎫 Ticket promedio</div>
                <div style='color:#5C6B7A; font-size:10px; margin-top:4px;'>Calibra tu precio al NSE y competencia de la zona.</div>
            </div>
            <div style='flex:1; min-width:160px; background:#F5F7FA; border-radius:8px; padding:10px 12px;'>
                <div style='color:#2A6FDB; font-weight:700; font-size:11px;'>🤝 Atención al cliente</div>
                <div style='color:#5C6B7A; font-size:10px; margin-top:4px;'>Tu rating en Google es tu segundo score de viabilidad.</div>
            </div>
            <div style='flex:1; min-width:160px; background:#F5F7FA; border-radius:8px; padding:10px 12px;'>
                <div style='color:#2A6FDB; font-weight:700; font-size:11px;'>📱 Presencia en redes</div>
                <div style='color:#5C6B7A; font-size:10px; margin-top:4px;'>Google Maps, Instagram y WhatsApp Business son esenciales para convertir tráfico en clientes.</div>
            </div>
        </div>
        </div>""", unsafe_allow_html=True)
    ...
    if tier_key == "free":
        # Free: solo gancho — sin resumen ejecutivo completo
        _score_color = color
        _factores_texto = "factores clave que determinan si esta ubicación es viable para tu negocio"
        st.markdown(f"""
<div style='background:#F0F6FF; border-left:4px solid #2A6FDB;
     border-radius:0 12px 12px 0; padding:16px 20px; margin:12px 0;'>
    <div style='font-size:14px; font-weight:700; color:#13243B; margin-bottom:6px;'>
        📋 Tu ubicación tiene score <span style='color:{_score_color};'>{score}</span> — pero hay más detrás de ese número
    </div>
    <div style='font-size:13px; color:#3A4A5E; line-height:1.7; margin-bottom:12px;'>
        El score refleja la competencia, pero la decisión real depende de
        <b>¿el NSE de la zona puede pagar tu producto?</b> y
        <b>¿qué negocios funcionan mejor en esta esquina específica?</b>
        — esas respuestas están en el plan Básico.
    </div>
    <div style='position:relative; border-radius:10px; overflow:hidden; margin-top:6px;'>
        <div style='padding:14px 16px; background:#122135 !important;'>
            <div style='font-size:12px; color:#C9D6E5 !important; margin-bottom:10px;'>
                <b style='color:#C9D6E5 !important;'>Desglose del score:</b>
                Densidad {desglose.get('densidad',0)}/100 ·
                Calidad {desglose.get('calidad',0)}/100 ·
                Consolidación {desglose.get('consolidacion',0)}/100
            </div>
            <div style='position:relative; border-radius:8px; overflow:hidden;'>
                <div style='filter:blur(5px); pointer-events:none; user-select:none;'>
                    <div style='font-size:12px; color:#C9D6E5 !important; margin-bottom:8px;'>
                        <b style='color:#C9D6E5 !important;'>NSE de la zona:</b> ▓/C+ · Ingreso promedio: $▓▓,▓▓▓ mensual
                    </div>
                    <div style='font-size:12px; color:#C9D6E5 !important;'>
                        <b style='color:#C9D6E5 !important;'>Top 5 para esta esquina:</b> 1.▓▓▓▓▓ 2.▓▓▓▓ 3.▓▓▓▓▓▓ 4.▓▓▓ 5.▓▓▓▓
                    </div>
                </div>
                <div style='position:absolute; inset:0; display:flex; align-items:center;
                     justify-content:center; background:rgba(13,27,42,0.30);'>
                    <span style='background:#E8A800; color:#13243B; font-weight:700; font-size:13px;
                         padding:8px 16px; border-radius:8px;'>🔒 Desbloquear NSE y top 5 — $99</span>
                </div>
            </div>
        </div>
    </div>
    ...
    # ── GANCHO POR TIER hacia el siguiente nivel ──────────────────
    if tier_key == "free":
        st.markdown(f"""
<div style='background:#FFFFFF; border:1px solid #E3E8EF; border-radius:12px;
     padding:20px 24px; margin:10px 0;'>
    <div style='color:#13243B !important; font-weight:600; font-size:15px; margin-bottom:8px;'>
        🔒 Reporte PowerPoint — disponible desde el plan Básico
    </div>
    <div style='color:#5C6B7A !important; font-size:12px; line-height:1.7; margin-bottom:16px;'>
        El plan Básico ($99 MXN) incluye reporte de 5 slides con desglose del score,
        perfil demográfico de la zona, NSE, competidores y top 5 negocios recomendados para esta ubicación.
    </div>
    <a href="{STRIPE_BASICO}" target="_blank"
       style='display:inline-block; background:#2A6FDB;
       padding:11px 24px; border-radius:8px; text-decoration:none;'>
       <span style='color:#FFFFFF !important; font-weight:700; font-size:13px;'>Obtener análisis completo — $99 MXN →</span></a>
</div>""", unsafe_allow_html=True)

    elif tier_key == "basic":
        st.markdown(f"""
<div style='background:#F0F6FF; border:1px solid #E8A800; border-radius:12px;
     padding:16px 20px; margin:16px 0;'>
    <div style='font-size:13px; font-weight:700; color:#13243B; margin-bottom:6px;'>
        ⬆️ ¿Quieres saber cuánto puedes vender en esta ubicación?
    </div>
    <div style='font-size:12px; color:#5C3800; line-height:1.6; margin-bottom:12px;'>
        El plan PRO ($499 MXN) agrega <b>forecast de ventas a 12 meses</b>,
        <b>ticket promedio de tus competidores</b>, mapa interactivo,
        tamaño de mercado potencial en pesos y <b>clientes/día estimados</b> —
        todo lo que necesitas para decidir con números reales.
    </div>
    <a href="{STRIPE_PRO}" target="_blank"
       style='display:inline-block; background:linear-gradient(135deg,#2A6FDB,#1F5FC2);
       color:#13243B; font-weight:700; font-size:12px; padding:8px 18px;
       border-radius:8px; text-decoration:none;'>Ver plan PRO — $499 MXN →</a>
</div>""", unsafe_allow_html=True)

    elif tier_key == "pro":
        st.markdown(f"""
<div style='background:#FFFBEF; border:1px solid #2A6FDB; border-radius:12px;
     padding:16px 20px; margin:16px 0;'>
    <div style='font-size:13px; font-weight:700; color:#3D2D00; margin-bottom:6px;'>
        💎 ¿Tienes más de una ubicación candidata o quieres saber cuándo recuperas la inversión?
    </div>
    <div style='font-size:12px; color:#5C4200; line-height:1.6; margin-bottom:12px;'>
        El plan Premium ($999 MXN) incluye <b>ROI estimado a 12 meses</b>,
        <b>meses para recuperar tu inversión</b>, punto de equilibrio mensual,
        comparativa radar entre hasta 3 ubicaciones, y un análisis de
        <b>cómo diferenciarte de la competencia</b> (qué destaca y critica la gente
        de cada competidor, basado en sus reseñas reales) — para tomar la decisión con certeza total.
    </div>
    <a href="{STRIPE_PREMIUM}" target="_blank"
       style='display:inline-block; background:linear-gradient(135deg,#2A6FDB,#E8C84A);
       color:#3D2D00; font-weight:700; font-size:12px; padding:8px 18px;
       border-radius:8px; text-decoration:none;'>Ver plan Premium — $999 MXN →</a>
</div>""", unsafe_allow_html=True)

    if PPTX_OK and tier_key == "free":
        pass  # Ya mostramos bloqueo arriba
    elif PPTX_OK:
        try:
    ...
    st.warning(f"Módulo PPTX no disponible: {_PPTX_ERROR if '_PPTX_ERROR' in dir() else 'ImportError'}")
...
<style>
  * {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .wrap {{ text-align: center; padding: 36px 32px 28px; background: #F8FAFC; border:1px solid #E3E8EF; border-radius: 16px; color: #13243B; }}
  .titulo {{ font-size: 22px; font-weight: 700; margin-bottom: 6px; }}
  .intro  {{ font-size: 12px; color: #5C6B7A; margin-bottom: 24px; }}
  .cards  {{ display: flex; justify-content: center; gap: 14px; flex-wrap: wrap; }}

  .card {{ background: #FFFFFF; border-radius: 12px; padding: 20px 18px;
  ...
  .card-basico  {{ border: 1px solid #E3E8EF; }}
  .card-pro     {{ border: 2px solid #2A6FDB; position: relative; }}
  .card-premium {{ border: 1px solid #2A6FDB; }}

  .badge-popular {{ position: absolute; top: -11px; left: 50%; transform: translateX(-50%);
    background: linear-gradient(135deg,#2A6FDB,#1F5FC2); color: #FFFFFF;
  ...
  .precio span {{ font-size: 11px; color: #5C6B7A; font-weight: 400; }}
  .usos {{ font-size: 10px; color: #8494A5; margin-bottom: 12px; }}

  .features {{ font-size: 10.5px; color: #3A4A5E; line-height: 1.9; margin-bottom: 16px; }}
  .features li {{ list-style: none; padding-left: 0; }}
  .features li::before {{ content: "✓ "; color: #2A6FDB; font-weight: 700; }}
  .features li.dim {{ color: #AAB4C0; }}
  .features li.dim::before {{ content: "— "; color: #C4CDD8; }}
  ...
  .btn-basico  {{ background: #13243B; color: #FFFFFF; }}
  .btn-basico:hover {{ background: #24405F; }}
  .btn-pro     {{ background: linear-gradient(135deg,#2A6FDB,#1F5FC2); color: #FFFFFF; }}
  .btn-pro:hover {{ background: linear-gradient(135deg,#1F5FC2,#3F86E8); }}
  .btn-premium {{ background: transparent; color: #2A6FDB; border: 1px solid #2A6FDB; }}
  .btn-premium:hover {{ background: rgba(42,111,219,0.12); }}

  .footer {{ margin-top: 22px; font-size: 11px; color: #555; }}
  .footer a {{ color: #2A6FDB; text-decoration: none; }}
...
<div class="wrap">
  ...
  <div class="cards">
    ...
    <div class="card card-basico">
      <div>
        <div class="tag" style="color:#5C6B7A;">BÁSICO</div>
        <div class="precio" style="color:#13243B;">$99 <span>MXN</span></div>
    ...
    <div class="card card-pro">
      ...
      <div>
        <div class="tag" style="color:#2A6FDB;">PRO</div>
        <div class="precio" style="color:#2A6FDB;">$499 <span>MXN</span></div>
    ...
    <div class="card card-premium">
      <div>
        <div class="tag" style="color:#2A6FDB;">PREMIUM 💎</div>
        <div class="precio" style="color:#2A6FDB;">$999 <span>MXN</span></div>
        ...
        <ul class="features">
          ...
          <li>Cómo diferenciarte de la competencia (basado en sus reseñas reales)</li>
