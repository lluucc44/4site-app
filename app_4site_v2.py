...
<div style='position:relative; border-radius:16px; overflow:hidden; margin-bottom:16px; min-height:260px;'>
    ...
    <div style='position:relative; z-index:2; text-align:center; padding:56px 20px 48px;'>
        <p style='color:#D4A85A; font-size:16px; margin:0 0 10px; font-style:italic;
...
<div style="background:#F9F9F9; border:1px solid #EBEBEB; border-radius:14px;
    ...
    <div style="display:flex; align-items:center; gap:16px; margin-bottom:12px;">
        ...
        <div>
            <p style="font-size:13px; font-weight:600; color:#0D0D0D; margin:0 0 2px;">Alto potencial ✅</p>
    ...
    <p style="font-size:10px; color:#BB944F; margin:10px 0 0; font-style:italic;">
...
<p style='font-size:12px; color:#888; margin:4px 0 0;'>
    ¿Ya compraste? <a href='#' style='color:#BB944F;'>Ingresa tu código arriba</a>
</p>
""", unsafe_allow_html=True)
...
with _col_flujo2:
    ...
    st.markdown(f"""<div style='background:#1A1A1A; border-left:3px solid #555;
        border-radius:6px; padding:8px 12px; font-size:11px; color:#AAAAAA; margin-top:22px;'>
...
if "resultados" in st.session_state:
    ...
    if _nota_veh and _tipo_flujo_ctx != "peatonal":
        _color_veh = "#4CAF50" if _estac_ctx else "#FFC107"
    ...
    if tier_key == "free":
        ...
        st.markdown(f"""
<div style='background:#FFF8EE; border-left:4px solid #BB944F;
     border-radius:0 12px 12px 0; padding:16px 20px; margin:12px 0;'>
    <div style='font-size:14px; font-weight:700; color:#3D2000; margin-bottom:6px;'>
    ...
    if tier_key == "free":
        st.markdown(f"""
<div style='background:#0D0D0D; border-radius:12px; padding:20px 24px; margin:10px 0;'>
    <div style='color:#BB944F; font-weight:700; font-size:15px; margin-bottom:8px;'>
    ...
    <a href="{STRIPE_BASICO}" target="_blank"
       style='display:inline-block; background:linear-gradient(135deg,#BB944F,#D4A85A);
       color:#0D0D0D; font-weight:700; font-size:13px; padding:10px 22px;
       border-radius:8px; text-decoration:none;'>Obtener análisis completo — $99 MXN →</a>
</div>""", unsafe_allow_html=True)

    elif tier_key == "basic":
        st.markdown(f"""
<div style='background:#FFF8EE; border:1px solid #E8A800; border-radius:12px;
     padding:16px 20px; margin:16px 0;'>
    <div style='font-size:13px; font-weight:700; color:#3D2000; margin-bottom:6px;'>
    ...
    <a href="{STRIPE_PRO}" target="_blank"
       style='display:inline-block; background:linear-gradient(135deg,#BB944F,#D4A85A);
       color:#0D0D0D; font-weight:700; font-size:12px; padding:8px 18px;
       border-radius:8px; text-decoration:none;'>Ver plan PRO — $499 MXN →</a>
</div>""", unsafe_allow_html=True)

    elif tier_key == "pro":
        st.markdown(f"""
<div style='background:#FFFBEF; border:1px solid #D4AF37; border-radius:12px;
     padding:16px 20px; margin:16px 0;'>
    ...
    <a href="{STRIPE_PREMIUM}" target="_blank"
       style='display:inline-block; background:linear-gradient(135deg,#D4AF37,#E8C84A);
