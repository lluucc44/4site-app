...
<div style='background:#F0F6FF; border-left:4px solid #2A6FDB;
    ...
    <div style='font-size:13px; color:#5C3800; line-height:1.7; margin-bottom:12px;'>
        El score refleja la competencia en la zona, pero la decisión real depende de
    ...
    <div style='display:flex; gap:10px; flex-wrap:wrap;'>
        <div style='background:#FFF3DC; border:1px solid #E8A800; border-radius:8px;
             padding:8px 12px; font-size:12px; color:#5C3800;'>
            🔒 Desglose por factor (qué sube y qué baja tu score)
        </div>
        <div style='background:#FFF3DC; border:1px solid #E8A800; border-radius:8px;
             padding:8px 12px; font-size:12px; color:#5C3800;'>
            🔒 NSE y perfil socioeconómico de la zona
        </div>
        <div style='background:#FFF3DC; border:1px solid #E8A800; border-radius:8px;
             padding:8px 12px; font-size:12px; color:#5C3800;'>
            🔒 Top 5 negocios recomendados para esta esquina
        </div>
        <div style='background:#FFF3DC; border:1px solid #E8A800; border-radius:8px;
             padding:8px 12px; font-size:12px; color:#5C3800;'>
            🔒 Resumen ejecutivo con ventajas, riesgos y recomendación
        </div>
    </div>
</div>""", unsafe_allow_html=True)
    else:
